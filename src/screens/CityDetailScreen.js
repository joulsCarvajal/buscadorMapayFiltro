...
export default function CityDetailScreen({ route, navigation }) {
  ...
  return (
    <View style={styles.container}>
      <View style={[styles.mapContainer, isLandscape ? styles.mapLandscape : styles.mapPortrait]}>
        <MapView
          style={styles.map}
          initialRegion={{
      ...
      <View style={[styles.infoContainer, isLandscape ? styles.infoLandscape : styles.infoPortrait]}>
